...
\section{Introduction}
    ...
    \section{Methodology}
        The project focuses on identifying anomalies in agricultural landscapes through the analysis of multi-temporal satellite imagery. The University of Sheffield hosts a prominent research group specializing in the detection and modeling of pest-driven crop degradation, in particular Fall Armyworm (FAW). Consequently, this research will be conducted in collaboration with experts in AD modeling and its practical applications in the agricultural sector. Together, we will explore the potential of applying RSAD frameworks to enhance the sensitivity and specificity of early-warning systems for crop protection.
    ...
    \subsection{Data and Study Regions}
        ...
        For this study, we selected two regions based on an literature review. The first is located in southern India, where \cite{prabhakar2022detecting} conducted field surveys to map Fall Armyworm (FAW) infestation sites. The second is Ejura, Ghana, a region previously mapped for FAW by \cite{bilintoh2019remote}.
    ...
    \section{Results and Discussion}
        ...
        \subsection{FAW infestation detection in Southern India with Sentinel-2}
            ...
            \subsubsection{Spectral Signatures of Pest Infestation}
                ...
                Based on the mean spectral response of the field ilustrated in Figure \ref{fig:india_spectral_severity_classification}, we can interpret the its results based on each spectral band characteristics. Near-Infrared (B8) carries information about leaf structure. Damage from pest feeding reduces reflectance in B8. Blue (B2) and Red (B4) carry chlorophyll information. Chlorophyll absorbs these wavelengths;reduction in absorption indicates decreased photosynthetic activity, often caused by pestfeeding on leaves. Shortwave Infrared (B10-B12) are sensitive to water content.Pest-damaged plants often exhibit water stress, detectable in these bands.
            ...
            However, as noted in \cite{bilintoh2019remote} work, the lack of specific dates for certain phenological stages or infestation events made the analysis difficult. This difficulty was compounded by gaps in the temporal resolution of satellite imagery and the presence of extensive cloud cover during the 2017 growing season, which limited the ability to capture the full maize phenological cycle as presented in Figure \ref{fig:extensive-cc}.
            ...
            The interpretation of these spectral curves is primarily constrained by a lack of contemporary field data to validate the remote sensing results. Consequently, the relationship between the observed spectral reflectance and actual crop health remains largely inferential. Without spatially explicit ground-truth points collected during the period of satellite overpass, it is complicated to statistically quantify the accuracy of the spectral signatures or to definitively distinguish FAW-induced stress from other localized environmental factors.
        ...
        \section{Application Development}
            In parallel to the RSAD modeling, I participated in app development testing for the PEZEGO pest-management app. The PEZEGO app focuses on providing actionable insights to farmers for pest management, and my involvement in this project allowed me to contribute to the development of user-friendly interfaces and efficient data processing pipelines.
...
\section{Internship Experience}
    ...
    \begin{figure}[!ht]
        ...
        \caption{Presenting my project results for the Pervasive Computing Group at the University of Sheffield.}
        \label{fig:presghana}
    \end{figure}
    \FloatBarrier
